...
#define  USB_CFG_VENDOR_ID       0xc0, 0x16 /* = 0x16c0 = 5824 */
 ...
 */
#define USB_CFG_VENDOR_NAME     '@', 'k', 'a', 'n', 't', 'o', 'n', 'i', 'a', 'k', \
								' ', '<', 'k', 'a', 'n', 't', 'o', 'n', 'i', 'a', \
								'k', '.', 'c', 'o', 'm', '>'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'S', 'i', 'n', 'g', 'l', 'e', '-', 'b', 'u', 't', \
								't', 'o', 'n', ' ', 'P', 'e', 'd', 'a', 'l', ' ', \
								'K', 'e', 'y', 'b', 'o', 'a', 'r', 'd'
...
#define USB_CFG_DEVICE_SUBCLASS     3
